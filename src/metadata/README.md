 ...
 * [SRAO.yml](SRAO.yml)
     * Determines how your purl.obolibrary.org/obo/SRAO/ redirects will be handled
     ...
     * Paste in the contents of [SRAO.yml](SRAO.yml)
 ...
 * [SRAO.md](SRAO.md)
     ...
     * Paste in the contents of [SRAO.md](SRAO.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
